    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6 form-control">
            <div class="bg-light rounded h-100 p-4 form-control">
                <h6 class="mb-4">Tag qo'shish</h6>
                <form method="POST" action="{{ route('admin.tags.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Tag uz</label>
                        <input type="text" name="tag_uz" class="form-control" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tag ru</label>
                        <input type="text" name="tag_ru" class="form-control" aria-describedby="emailHelp">
                    </div>
