      ...
      <div class="container">
        <div class="basic-flex header__top">
          ...
          <div class="currencies basic-flex">
            ...
            @endphp
            <div class="currency"><span>$</span><span>{{$arr['usd']}} </span></div>
            <div class="currency"><span>P</span><span>{{$arr['rubl']}}</span></div>
            <div class="currency"><span>E</span><span>{{ $arr['eur']}}</span></div>
          </div>
          <div class="header__actions basic-flex">
            <form method="GET" action="/pages/search" class="search-form basic-flex">
              @csrf
